...
Utilisateur.hasMany(Messagerie, { foreignKey: 'id_expediteur', as: 'messages_envoyes' });
Utilisateur.hasMany(Messagerie, { foreignKey: 'id_destinataire', as: 'messages_recus' });
